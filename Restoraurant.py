...
put_row(
    [
        put_column(
            [put_image(images.PIZZA_IMAGE, width='180px', height='120px'), put_text(f'Піца {prices.PIZZA_PRICE}')]),
        put_column(
...
causes = checkbox(label='Causes', options=['майоніз', 'кетчуп', 'гірчиця'])
...
# Output Examples and Markdown Styling
# output examples
put_warning('warning')
put_error('error')
